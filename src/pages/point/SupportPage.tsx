...
export const SupportPage = () => {
  ...
  const faqs = [
    ...
    { q: 'What if a customer forgets their release code?', a: 'Customers can resend the code to their registered phone number via the WeSabiHub app or website.' },
    ...
    <PointLayout>
      <div className="space-y-10 max-w-5xl mx-auto pb-20">
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-slate-900">Access exclusive support resources for WeSabiHub Point operators.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           {[
             ...
             { title: 'Email Tickets', desc: 'For complex disputes', icon: Mail, color: 'text-indigo-600', bg: 'bg-indigo-50 dark:bg-indigo-900/20', handler: () => window.location.href = 'mailto:points@wesabihub.com' },
           ].map((channel, i) => (
              ...
              <Card className="p-8 border-slate-200 dark:border-slate-800 bg-slate-900 text-white space-y-6">
                 ...
                 <div className="space-y-2">
                    ...
                    <p className="text-slate-800 text-xs leading-relaxed">
                       Read our guides on running a WeSabiHub Point smoothly, from intake to release.
                    </p>
                 </div>
