...
export const FAQPage = () => {
  ...
  const defaultFaqs = [
    {
      question: 'What is WeSabiHub?',
      answer: 'WeSabiHub is a nationwide Pick-Up & Drop-Off (PUDO) network that connects customers, merchants, and logistics partners through verified neighborhood business centers. We provide a secure way to send and receive parcels without needing home delivery.',
      category: 'General'
    },
    {
      question: 'Is WeSabiHub a courier company?',
      answer: 'No, WeSabiHub is the infrastructure and technology platform. We partner with verified neighborhood businesses to act as hubs and with professional logistics companies to transport parcels between these hubs.',
      category: 'General'
    },
    {
      question: 'In which cities is WeSabiHub available?',
    ...
    },
    {
      ...
      answer: 'Register your parcel on our website or app to get a booking code. Take the parcel to your nearest WeSabiHub center, show the code, and hand over the item. The recipient will be notified once it arrives at their chosen destination hub.',
    ...
    {
      question: 'What items are prohibited on WeSabiHub?',
    ...
    },
    {
      ...
      answer: 'Any independent rider or commercial courier business with a valid vehicle (motorcycle, van, or truck), a Class-A driving license, a smartphone, and a verified background check can apply to become a WeSabiDispatch Rider.',
      category: 'WeSabiDispatch & Riders'
    },
    {
    ...
    },
    {
      ...
      answer: 'Our SafePay ledger system secures all shipping payments. When a customer pays, the funds route into the WeSabi SafePay Wallet. Upon successful recipient delivery confirmation (via QR code scan), the delivery portion of the fee triggers instantly to your rider wallet.',
      category: 'WeSabiDispatch & Riders'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes! WeSabiHub features an integrated multi-role architecture. If you are already a verified merchant, you can activate Dispatch Rider capabilities inside your existing profile and handle transit jobs with a single account.',
      category: 'WeSabiDispatch & Riders'
    },
    {
    ...
    {
      question: 'Can API partners use WeSabiDispatch?',
      answer: 'Yes. Our developer and enterprise API platform fully exposes the WeSabiDispatch network, allowing third-party apps, websites, and marketplaces to request pickups, track transits, and verify deliveries automatically.',
      category: 'WeSabiDispatch & Riders'
    }
  ];
